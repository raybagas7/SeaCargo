...
function TotalIncome() {
  ...
  return (
    <div className="grid flex-1  grid-rows-2 rounded-lg bg-prim-libg">
      <div className="grid grid-cols-2 gap-5 border-border-light p-5 dark:border-border-dark">
        <div className="grid grid-rows-2 gap-3 rounded-lg border-[1px] border-border-light p-5 shadow-md">
          <div>
            <h3 className="font-bold">Total Shipping Cost / Predicted</h3>
            <p className="text-[2rem] text-cyan-500">
          ...
          <div>
            ...
            <p className="text-[2rem] text-prim-light">
              +Rp{" "}
              {currencyFormat.format(earning?.total_shipping_paid as number)}
            </p>
          </div>
        </div>
        <div className="grid grid-rows-2 gap-3 rounded-lg border-[1px] border-border-light p-5 shadow-md">
          <div>
            <h3 className="font-bold">Total Shipping Pending / Unpaid</h3>
            <p className="text-[2rem] text-yellow-500">
      ...
      <div className="grid grid-cols-2 gap-5 border-border-light p-5 dark:border-border-dark">
        <div className="grid grid-rows-2 gap-3 rounded-lg border-[1px] border-border-light p-5 shadow-md">
          ...
          <div>
            ...
            <p className="text-[2rem] text-red-500">
              -Rp{" "}
              {currencyFormat.format(earning?.total_cutted_amount as number)}
            </p>
          </div>
        </div>
        <div className="grid grid-rows-2 gap-3 rounded-lg border-[1px] border-border-light p-5 shadow-md">
